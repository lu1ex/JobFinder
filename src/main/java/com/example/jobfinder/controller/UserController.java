...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<UserDTO> createUser(@RequestBody UserRequestBodyModel userRequestBodyModel) {
    ...
    public ResponseEntity<Set<UserDTO>> getAllUsers() {
        Set<UserEntity> userEntitySet = userService.getAllEntities();
        Set<UserDTO> userDTOSet = mapperService.mapSetToSetOfClass(userEntitySet, UserDTO.class);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserDTO> updateEntityByPut(
            @PathVariable String id, @RequestBody UserRequestBodyModel userRequestBodyModel) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<UserDTO> updateEntityByPatch(
